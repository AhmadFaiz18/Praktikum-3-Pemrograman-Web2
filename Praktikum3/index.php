...
<body>
    <div class="container mt-5 mx-10">
        <fieldset>
            <legend style="font-family: Georgia, 'Times New Roman', Times, serif;">Form Registrasi IT Club Data Science</legend>
            <form method="POST" action="">
                ...
                <div class="form-group row">
                    <div class="offset-3 col-6">
                        <input type="submit" name="proses" class="btn btn-secondary">
                    </div>
                </div>
            </form>
        </fieldset>
